package es.uma.asenjo.DemoGoingFaster;
...
public class Support {
    ...
    /* Method to calculate the rotation angle for the camera images */
    /* This angle depends on the display orientation and the camera info */
